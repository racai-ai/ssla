 ...
 */
package ro.racai.tts.WS.TTS.hmm;
...
public class PStream {
    ...
    /* Constructor */
    public PStream(int vector_size, int utt_length, int maxIterationsGV) throws Exception {
    ...
    /**
     * dynamic features must be 0.0f for the rightmost (and also leftmost?)
     * parameter prior to optimization
     */
     ...
     */
    public void mlpg(boolean useGV) {
...
//                }
    ...
    /**
     * ldlFactorization: Factorize W'*U^{-1}*W to L*D*L' (L: lower triangular,
     * D: diagonal)
     */
